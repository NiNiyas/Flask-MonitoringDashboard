...
if not micro:
    with open(loc + "/requirements.txt") as f:
        required.extend(
            [req for req in f.read().splitlines() if req != "-r requirements-micro.txt"]
        )
...
if micro:
    packages = setuptools.find_packages(
        ...
        exclude=[
            "flask_monitoringdashboard.controllers.*",
...
setuptools.setup(
    ...
    if not micro
    else "Flask-MonitoringDashboard-Micro",
    ...
    project_urls={
        ...
        "Documentation": "https://flask-monitoringdashboard.readthedocs.io/en/latest",
